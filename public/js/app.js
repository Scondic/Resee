...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/products').then(function (response) {
      return _this.contents = response.data;
    });
  }
});
...
Vue.component('card-products', __webpack_require__(/*! ./components/CardProduct */ "./resources/js/components/CardProduct.vue").default);
var app = new Vue({
  el: '#app'
});
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "grid grid md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-3 mb-6"
    },
    _vm._l(_vm.contents, function(content, index) {
      return _c(
        ...
        {
          key: content.id,
          staticClass: "flex bg-white rounded-md p-4",
        ...
        [
          _c(
            ...
            {
              staticClass:
                "flex justify-center items-center bg-fill rounded-md p-8"
            },
            [
              _c("img", {
                staticClass: "w-12",
                attrs: { src: _vm.contents[index].image, alt: "Изображение" }
              })
            ]
          ),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "flex flex-col justify-between w-full pl-4" },
            [
              _c("div", {}, [
                _c("h5", {}, [_vm._v(_vm._s(_vm.contents[index].name))]),
                _vm._v(" "),
                _c("div", { staticClass: "font-medium text-light" }, [
                  _vm._v(
                    _vm._s(_vm.contents[index].price) +
                      " ₽ за " +
                      _vm._s(_vm.contents[index].number) +
                      " шт."
                  )
                ])
              ]),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "flex" }, [
      _c("button", { staticClass: "btn btn-fill" }, [_vm._v("В корзину")])
    ])
  }
]
